...
extern "C" void simulation_master(unsigned int *post_trial_chem_amounts, crn_t crn_h, sim_params_t sim_params, output_stats_t *out_stats,
                                        unsigned int *triggered_thresh, bool *within_threshold, unsigned int trial_num, int *err);
